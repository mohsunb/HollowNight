...
public class HuskBully extends Creature
{
    ...
    public HuskBully(Handler handler, float x, float y)
    {
        ...
        if (exists)
        {
            ...
            if (attacking)
            {
                if (!attack_blocked)
                    attack_blocked = true;
                attack_timer++;
                if (attack_timer >= Launcher.framerate_limit * 0.334f)
                {
                    attack_timer = 0;
                    attacking = false;
                }
    ...
    public void render(Graphics2D gfx)
    {
        if (exists)
        {
            ...
            {
                if (facing_right)
                    gfx.drawImage(Assets.husk_bully_idle, (int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset() + 10), null);
                else
                    gfx.drawImage(Utils.mirrorImage(Assets.husk_bully_idle), (int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset() + 10), null);
            }

            else if (attacking)
            {
                if (facing_right)
                    gfx.drawImage(Assets.husk_bully_attack, (int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset() + 20), null);
                else
                    gfx.drawImage(Utils.mirrorImage(Assets.husk_bully_attack), (int) (x - handler.getCamera().getxOffset() - 20), (int) (y - handler.getCamera().getyOffset() + 20), null);
            }

            else
            {
                if (facing_right)
                    gfx.drawImage(Assets.husk_bully_walk, (int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset() + 15), null);
                else
                    gfx.drawImage(Utils.mirrorImage(Assets.husk_bully_walk), (int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset() + 15), null);
            }
        }
        ...
        {
            if (facing_right)
                gfx.drawImage(Assets.husk_bully_corpse, (int) (x - handler.getCamera().getxOffset() - 100), (int) (y - handler.getCamera().getyOffset() + 45), null);
            else
                gfx.drawImage(Utils.mirrorImage(Assets.husk_bully_corpse), (int) (x - handler.getCamera().getxOffset() + 50), (int) (y - handler.getCamera().getyOffset() + 45), null);
        }
