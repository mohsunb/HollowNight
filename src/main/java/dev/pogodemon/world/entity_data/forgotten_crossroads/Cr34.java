...
public class Cr34 extends EntityData
{
    public static final int RIGHT = 0;

    public Cr34(Handler handler)
    {
        super(handler);
    }
    ...
    public void spawnEntities()
    {
        ...
        handler.getWorld().spawnEntity(new RoomTransition(handler, 8120, 1800, 80, 280, new World(handler, MapHelper.CR33, Cr33.LEFT), new Cr33(handler), 1));

        handler.getWorld().spawnEntity(new GeoDeposit(handler, 6641, 200, 2, "rock_23"));
    }
}