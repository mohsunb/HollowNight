...
public class Cr40 extends EntityData
{
    public static final int LEFT = 0;

    public Cr40(Handler handler)
    {
        super(handler);
    }
    ...
    public void spawnEntities()
    {
        ...
        handler.getWorld().spawnEntity(new RoomTransition(handler, 40, 200, 80, 280, new World(handler, MapHelper.CR39, Cr39.RIGHT_2), new Cr39(handler), 3));
    }
}